...
This repository uses pandas for data manipulation, numpy for numerical computations, and matplotlib for visualizations.
Each problem is clearly marked with headings in the notebook, and Markdown cells provide explanations and insights.
Ensure you have a stable Python environment and Jupyter installed before running the notebook.
...
This README satisfies the following requirements:

- Has a **Level 1 heading** with project title.
- Includes a **brief description** of the repository.
- Has a **Contents section** listing Problems 1–8.
- Contains **setup instructions** for cloning, installing packages, and opening the notebook.
